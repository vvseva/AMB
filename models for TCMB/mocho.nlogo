...
to buy
    if (color = blue) [buy-shops]
    if (color = red) [buy-coffe]
    if (color = yellow) [buy-field]
    if (color = green) [buy-cheese]
end

to buy-shops
  if (cube = 4) [
    set wealth wealth + cards * 4
  ]
  if (wealth > 4) [
    set wealth wealth - 4
    set cards cards + 1
...
to buy-coffe
  if (cube = 3) [
    ask other turtles [
      set wealth wealth - 2 * cards
    ]
    set wealth wealth + cards * 2
  ]
  if (wealth > 3) [
    set wealth wealth - 3
    set cards cards + 1
...
to-report top-10-pct-cards
  report sum [ cards ] of max-n-of (count turtles * 0.10) turtles [ cards ]
end

to-report bottom-50-pct-cards
  report sum [ cards ] of min-n-of (count turtles * 0.50) turtles [ cards ]
end
...
"" ""
PENS
"top 10%" 1.0 0 -2674135 true "" "plot top-10-pct-cards"
"bottom 50%" 1.0 0 -13345367 true "" "plot bottom-50-pct-cards"
