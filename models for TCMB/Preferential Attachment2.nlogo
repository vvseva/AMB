...
to setup
  clear-all
  ;;; NEW CODE HERE
  set colors [ red green yellow blue orange pink]
...
to make-node [old-node]
    ...
    ;; NEW CODE HERE
  set colornow (item (random number-of-ethnicities) colors)
      ;; end of a new code
...
to-report find-partner
  ...
  ;; 50%-50% chance for color homophily
  ifelse random 100 > homophily [
    report [one-of both-ends] of one-of links
  ]
  [
    ;report[ one-of both-ends with [[color] of self] ] of one-of links
    report[one-of both-ends with [color = colornow]] of one-of links
  ]
